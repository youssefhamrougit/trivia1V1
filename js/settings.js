...
const Settings = (function () {
  ...
  const translations = {
    ...
    ar: {
      ...
      "home.trophies_to": "{n} كؤوس إلى {name}",
      "home.max_arena": "وصلت إلى أقصى ساحة — أنت أسطورة!",
      ...
      "match.cancel": "إلغاء",
      "match.vs": "ضد",
      "match.searching_human": "جارٍ البحث عن خصم بشري… ({n} ثانية)",
      "match.opponent_starting": "تم العثور على خصم — جارٍ البدء…",
      "match.question_of": "سؤال {cur} من {total} · {secs} ثانية لكل سؤال",
      "match.streak": "سلسلة {n}",
      "match.streak_zero": "سلسلة: {n}",
      "match.waiting_for": "انتظار {name}…",
      "match.wrong_waiting": "خطأ — انتظار {name}…",
      "result.win": "لقد فزت!",
      "result.tie": "تعادل!",
      "result.lost": "لقد خسرت!",
      "result.trophies": "{n} كؤوس",
      "result.trophy": "{n} كأس",
      "result.no_change": "لا تغيّر في الكؤوس",
      "result.friendly_duel": "مباراة ودية — لا تغيّر في الترتيب",
      "result.network_error": "تعذّر الاتصال بالشبكة — لا تغيّر في الترتيب",
      "result.quizbot_fallback": "لم يتم العثور على بشر — لُعب ضد البوت (لا تغيّر في الترتيب)",
      "result.practice": "لعبة تدريبية — لا تغيّر في الترتيب",
      "result.arena_unlocked": "تم فتح الساحة: {name}!",
      ...
      "friends.type_chars": "اكتب حرفين على الأقل.",
      "friends.no_players": "لم يتم العثور على لاعبين.",
      "friends.add_btn": "إضافة",
      "friends.sent": "أُرسل",
      "friends.friends_label": "أصدقاء",
      "friends.trophies_label": "كؤوس",
      "friends.requests_heading": "الطلبات {n}",
      "friends.wants_battle": "يريد المعركة",
      "friends.accept": "قبول",
      "friends.decline": "رفض",
      "friends.your_friends": "أصدقاؤك {n}",
      "friends.no_friends": "لا أصدقاء بعد — ابحث عن شخص أعلاه.",
      "friends.cancel_challenge": "إلغاء",
      "friends.remove_title": "إزالة صديق",
      "friends.challenges_heading": "التحديات",
      "friends.challenged_you": "تحدّاك في مباراة!",
      "toast.request_sent": "تم إرسال طلب الصداقة!",
      "toast.already_friends": "أنتم أصدقاء بالفعل",
      "toast.request_exists": "يوجد طلب بالفعل",
      "toast.thats_you": "هذا أنت!",
      "toast.cant_friend_bot": "لا يمكن إضافة بوت المسابقة كصديق",
      "toast.user_not_found": "لا يوجد لاعب بهذا الاسم",
      "toast.something_wrong": "حدث خطأ ما",
      "toast.couldnt_send": "تعذّر إرسال الطلب.",
      "toast.now_friends": "أنتم الآن أصدقاء!",
      "toast.couldnt_accept": "تعذّر القبول.",
      "toast.request_declined": "تم رفض الطلب",
      "toast.couldnt_decline": "تعذّر الرفض.",
      "toast.friend_removed": "تمت إزالة الصديق",
      "toast.couldnt_remove": "تعذّت الإزالة.",
      "toast.remove_friend_confirm": "إزالة هذا الصديق؟",
      "toast.challenge_pending": "يوجد تحدي معلّق لهذا الصديق بالفعل.",
      "toast.challenge_sent": "أُرسل التحدي — بانتظار صديقك",
      "toast.challenge_declined": "رفض صديقك التحدي",
      "toast.challenge_expired": "لم يجب صديقك — انتهت صلاحية التحدي.",
      "toast.challenge_accepted": "تم قبول التحدي — حظًا سعيدًا!",
      "toast.challenge_couldnt_accept": "تعذّر قبول التحدي.",
      "toast.challenge_declined_ok": "تم رفض التحدي",
      "toast.challenge_couldnt_decline": "تعذّر رفض التحدي.",
      "toast.challenge_cancelled": "تم إلغاء التحدي",
      "toast.challenge_couldnt_cancel": "تعذّر إلغاء التحدي.",
      "toast.opponent_found": "تم العثور على خصم — حظًا سعيدًا!",
      "toast.been_challenged": "لقد تُحدّيت — تحقق من الأصدقاء!",
      ...
      "arena.unlocked_req": "تم الوصول إلى {n} كؤوس",
      "arena.continue": "متابعة",
      "arena.your_arena": "★ ساحتك",
      "arena.unlocked_badge": "مفتحة",
      "arena.locked_badge": "مقفلة",
      "arena.climbing_here": "أنت تتسلق هنا",
      "arena.everyone_starts": "الجميع يبدأ هنا",
      "arena.unlocked_at": "مفتحة عند {n} كؤوس",
      "arena.reach_unlock": "اصل إلى {n} كؤوس لفتحها",
      "arena.swipe_hint": "اسحب أو مرر أو استخدم ← → لاستكشاف الساحات",
      "leaderboard.loading": "جارٍ التحميل…",
      "leaderboard.cant_load": "تعذّر تحميل لوحة الصدارة.",
      "leaderboard.no_players": "لا يوجد لاعبون بعد. كن الأول!",
      "leaderboard.you": "(أنت)",
      "stats.loading": "جارٍ التحميل…",
      "stats.cant_load": "تعذّر تحميل إحصائياتك.",
      "stats.cant_load_history": "تعذّر تحميل سجل المباريات.",
      "stats.overall_accuracy": "الدقة الإجمالية",
      "stats.answers_of": "{correct} من {total} إجابات",
      "stats.by_category": "الدقة حسب الفئة",
      "stats.no_data": "أجب عن بعض الأسئلة وستظهر دقتك لكل فئة هنا.",
      "stats.match_history": "سجل المباريات",
      "stats.no_history": "لا توجد مباريات منتهية بعد — مبارياتك المصنّفة والودية ستظهر هنا بعد انتهائها (مباريات التمارين غير مدرجة).",
      "share.text": "حصلت على {score} في Trivia1v1! هل يمكنك تجاوزي؟",
      "share.copied": "تم نسخ النتيجة! الصقها لأصدقائك.",
      "error.username_invalid": "اسم المستخدم: ٣-٢٠ حرف أو رقم أو شرطة سفلية.",
      "error.password_short": "يجب أن تكون كلمة المرور ٦ أحرف على الأقل.",
      "error.enter_credentials": "أدخل اسم المستخدم وكلمة المرور.",
      "error.email_confirm": "تم إنشاء الحساب! أكّد بريدك الإلكتروني أولاً ثم سجّل الدخول. (أو أوقف \"تأكيد البريد\" في Supabase — انظر README.)",
      "error.couldnt_join": "تعذّر الانضمام للبحث عن مباراة: {msg}",
      "error.couldnt_load_match": "تعذّر تحميل المباراة: {msg}",
      "error.couldnt_load_questions": "تعذّر تحميل الأسئلة: {msg}",
      "error.friend_no_accept": "لم يقبل صديقك التحدي. حاول مرة أخرى!",
      "error.no_opponent": "لم يتم العثور على خصم بعد. حاول لحظة أخرى!",
      "error.check_email_login": "تحقق من بريدك الإلكتروني أو سجّل الدخول.",
      "error.friends_not_setup": "ميزة الأصدقاء لم تُعدّ بعد — شغّل ملف database/friends-bots.sql (انظر README).",
